...
```
***
# 1.02 Additional Roots
## 1.02-01 Typography and Font Variables
```
:root {
    /* Font Sizes */
...
```
## 1.02-03 Shadows and Elevations
```
:root {
    /* Box Shadows */
...
```
## 1.02-05 Transitions and Animations
```
:root {
...
```
***
# 1.04 Pick A Palette, and Stick to it
```
.theme-light {
	--color001: #hex;
	--color002: #hex;
...
```
## 1.05-25 Search Command Palette
```
...
```
## 1.05- 27 Sync Avatar (optional if you keep track of multiple vaults)
